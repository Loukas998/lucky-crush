...
namespace LuckyCrush.Infrastructure.Migrations
{
    ...
    [Migration("20250922175426_UserLevelRockDestruction")]
    partial class UserLevelRockDestruction
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LuckyCrush.Domain.Entities.Game.Rock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LuckyCrush.Domain.Entities.Levels.Destruction", b =>
                {
                    ...
                    b.Property<int>("QuantityDestructed")
                        .HasColumnType("int");

                    b.HasKey("RockId", "MatchId");
            ...
            modelBuilder.Entity("LuckyCrush.Domain.Entities.Levels.Requirement", b =>
                {
                    b.Property<int>("LevelId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LuckyCrush.Domain.Entities.Levels.UserLevel", b =>
                {
                    b.Property<int>("LevelId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PrizeWheel", b =>
                {
                    b.Property<int>("PrizesId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("PrizesId", "WheelsId");

                    b.HasIndex("WheelsId");

                    b.ToTable("PrizeWheel");
                });
            ...
            modelBuilder.Entity("LuckyCrush.Domain.Entities.Levels.Destruction", b =>
                {
                    b.HasOne("LuckyCrush.Domain.Entities.Levels.Match", null)
                        .WithMany("Destructions")
                        .HasForeignKey("MatchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LuckyCrush.Domain.Entities.Game.Rock", null)
                        .WithMany("Destructions")
            ...
            modelBuilder.Entity("LuckyCrush.Domain.Entities.Levels.Requirement", b =>
                {
                    ...
                    b.HasOne("LuckyCrush.Domain.Entities.Game.Rock", "Rock")
                        .WithMany("Requirements")
                        .HasForeignKey("RockId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PrizeWheel", b =>
                {
                    ...
                    b.HasOne("LuckyCrush.Domain.Entities.Wheels.Wheel", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RewardUser", b =>
                {
                    b.HasOne("LuckyCrush.Domain.Entities.Tasks.Reward", null)
                        .WithMany()
